...
save_name= '/home/new/xct/result/five_fold/eff_dense_improve2/improve_eff_dense202_acc_91.63879598662207.pth'
load_models = torch.load(save_name)
model.load_state_dict(load_models['model'].state_dict())
model1.load_state_dict(load_models['model1'].state_dict())
...
print('kaishi')
'''-------------------------------------------------------'''
csvFile = open("/home/new/xct/result/five_fold/eff_dense_improve2/s_ziv_9163_.csv", "w",encoding='utf-8',newline="")            #创建csv文件
writer = csv.writer(csvFile)                  #创建写的对象
#先写入columns_name
writer.writerow(["image","none","infection","ischaemia","both"])     #写入列的名称

#读入图片
test_root = '/home/new/xct/val_official/Val2021'
...
# load_models = torch.load(save_name)
# model_1 = load_models['model1']
# model_2 = load_models['model2']